...
export function TradeWorkspace({ profile, isAdminView = false, isGuest = false }: Props) {
  ...
  const [pickMode, setPickMode] = useState<"sl" | "tp" | "limit" | null>(null);
  const [pickedPrice, setPickedPrice] = useState<{ mode: "sl" | "tp" | "limit"; price: number | null; nonce: number } | null>(null);
