...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "Open Trader — Crypto Trading Protocol" },
      { name: "description", content: "Open-source, community-built crypto trading protocol with live markets." },
      { property: "og:title", content: "Open Trader — Crypto Trading Protocol" },
      { property: "og:description", content: "Open-source, community-built crypto trading protocol with live markets." },
      { property: "og:type", content: "website" },
      { name: "twitter:card", content: "summary" },
      { name: "twitter:title", content: "Open Trader — Crypto Trading Protocol" },
      { name: "twitter:description", content: "Open-source, community-built crypto trading protocol with live markets." },
